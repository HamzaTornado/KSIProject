...
namespace MinisitreFin.Controllers
{
    ...
    public class ExamensController : Controller
    {
        ...
        {
            var examens = db.Examens.Include(e => e.Patient);
        ...
        public ActionResult Create(int? idpatient)
        {
            ...
            ViewBag.A_Text = new SelectList(QA_AnswersList(), "value", "text");
            ViewBag.B_Text = new SelectList(QB_AnswersList(), "value", "text");
            ViewBag.C_Text = new SelectList(QC_AnswersList(), "value", "text");
            ViewBag.D_Text = new SelectList(QD_AnswersList(), "value", "text");
            ViewBag.E_Text = new SelectList(QE_AnswersList(), "value", "text");
            ViewBag.F_Text = new SelectList(QF_AnswersList(), "value", "text");
            ViewBag.G_Text = new SelectList(QG_AnswersList(), "value", "text");
            ViewBag.H_Text = new SelectList(QH_AnswersList(), "value", "text");
            ViewBag.I_Text = new SelectList(QI_AnswersList(), "value", "text");
            ViewBag.J_Text = new SelectList(QJ_AnswersList(), "value", "text");
